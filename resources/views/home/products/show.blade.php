            ...
            <div class="row" style="direction: rtl;">
                        ...
                        <div class="tab-content description-review-bottom">
                            ...
                            <div id="des-details2" class="tab-pane {{ count($errors) > 0 ? 'active' : '' }}">
                                ...
                                <div class="review-wrapper">
                                    @foreach ($product->approveComments as $comment)
                                        <div class="single-review">
                                            <div class="review-img">
                                                <img src="{{ $comment->user->avater == null ? asset('home/assets/user.png') : $comment->user->avater }}"
                                                    alt="">
                                            </div>
                                            <div class="review-content w-100 text-right">
                                                ...
                                                <div class="review-top-wrap">
                                                    <div class="review-name">
                                                        <h4>{{ $comment->user->name == null ? 'کاربر گرامی' : $comment->user->name }}
                                                        </h4>
                                                    </div>
                                                    <div data-rating-stars="5" data-rating-readonly="true"
                                ...
                                <div class="ratting-form-wrapper text-right">
                                    ...
                                    <div class="star-box-wrap">
                                        <div id="dataReadonlyReview" data-rating-stars="5" data-rating-value="0"
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="pro-dec-banner">
                        <a href="#"><img src="{{ asset('upload/files/banners/images/banner-7.png') }}"
                                alt=""></a>
                    </div>
                </div>
            </div>
