                ...
                <div class="col-xl-2 col-lg-2">
                    <div class="logo pt-40">
                        <a href="{{ route('home.index') }}">
                            <h3 class="font-weight-bold">Mahroghi.ir</h3>
                        </a>
                    </div>
                </div>
                        ...
                        <nav>
                            <ul>
                                <li class="angle-shape">
                                    <a href="{{ route('home.about_us') }}"> درباره ی ما</a>
                                </li>

                                <li><a href="{{ route('home.contact_us') }}"> تماس با ما </a></li>

                                <li class="angle-shape">
                                    <a href="#"> فروشگاه </a>
                                    @php
                                        $parentCategories = App\Models\Category::where('parent_id', '0')->get();
                                        $parentCategories2 = App\Models\Category::where('name', 'مردانه')->first();
                                        //dd($parentCategories2->childred);
                                    @endphp
                                    <ul class="mega-menu">
                        ...
                        <div class="cart-wrap">
                            ...
                            @if (\Cart::isEmpty())
                                <div class="shopping-cart-content">
                                    ...
                                    <p class="mt-5 text-center text-bold" style="color: red">سبد خرید شما خالی است</p>
                                        ...
                                        @foreach (\Cart::getContent() as $item)
                                            <li class="single-shopping-cart">
                                                ...
                                                <div class="shopping-cart-img">
                                                    <a
                                                        href="{{ route('home.products.show', $item->associatedModel->slug) }}"><img
                                                            alt=""
