...
@section('content')
    ...
    <div class="banner-area pt-100 pb-65">
        <div class="container">
            <div class="row">
                ...
                @foreach ($indexTopBanners->chunk(3)->first() as $topBanner1)
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{ $topBanner1->button_link }}"><img class="animated"
                                    src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $topBanner1->image) }}"
                                    alt="{{ $topBanner1->image }}" /></a>
                            <div class="banner-content-2 banner-position-5">
                                <h4>{{ $topBanner1->title }}</h4>
                            </div>
                        </div>
                    </div>
                @endforeach

                @foreach ($indexTopBanners->chunk(3)->last() as $topBanner2)
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{ $topBanner2->button_link }}"><img class="animated"
                                    src="{{ asset(env('BANNER_IMAGES_UPLOAD_PATH') . $topBanner2->image) }}"
                                    alt="" /></a>
                            <div
                                class="{{ $loop->last ? 'banner-content-3 banner-position-7' : 'banner-content banner-position-6 text-right' }}">
                                <h3>{{ $topBanner2->title }}</h3>
                                <a href="{{ $topBanner2->button_link }}">{{ $topBanner2->button_text }}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                                    ...
                                    <div class="ht-product-image-wrap">
                                        ...
                                        <div class="ht-product-action">
                                            <ul>
                                                ...
                                                <li>
                                                    @auth
                                                        @if ($product->checkUserWishlist(auth()->id()))
                                                            <a href="{{ route('home.wishlist.remove', $product->id) }}"><i
                                                                    class="fas fa-heart" style="color:red"></i>
                                                                <span class="ht-product-action-tooltip">
                                                                    به لیست علاقه مندی اضافه شده است
                                                                </span>
                                                            </a>
                                                        @else
                                                            <a href="{{ route('home.wishlist.add', $product->id) }}"><i
                                                ...
                                                <li>
                                                    <a href="{{ route('home.compare.add', $product) }}"><i
    ...
    <div class="banner-area pb-120">
        <div class="container">
            <div class="row">
                @foreach ($indexBottomBanners->chunk(3)->last() as $bottomBanner)
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12" style="direction: rtl;">
                                <div class="product-details-content quickview-content">
                                    ...
                                    <div class="pro-details-rating-wrap">
                                        ...
                                        <span>{{ $product->approveComments()->count() }} دیدگاه</span>
                                    </div>
                                    <p class="text-right">
                                        {{ $product->description }}
                                    </p>
                                            ...
                                            <div class="pro-details-quality">
                                                ...
                                                <div class="pro-details-compare">
                                                    <a title="Add To Compare"
                                                        href="{{ route('home.compare.add', $product->id) }}">
