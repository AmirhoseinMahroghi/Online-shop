                                        ...
                                        @foreach (\Cart::getContent() as $item)
                                            <tr>
                                                ...
                                                <td class="product-name"><a
                                                        href="{{ route('home.products.show', $item->associatedModel->slug) }}">
                                                        {{ $item->name }} </a>
                                ...
                                <div class="discount-code-wrapper">
                                    ...
                                    <div class="discount-code">
                                        ...
                                        @if (session()->has('coupon'))
                                            <form action="{{ route('home.forget_coupon') }}" method="POST">
                                                @csrf
                                                <input type="text" value="{{ session('coupon.code') }}">
                                                <button class="btn btn-sm btn-danger" type="submit"> حذف کد تخفیف </button>
                                            </form>
                                        @else
