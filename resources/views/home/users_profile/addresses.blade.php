                                    ...
                                    <div class="myaccount-content address-content">
                                        ...
                                        @foreach ($addresses as $address)
                                            <div>
                                                ...
                                                <div class="collapse p-4" id="collapse-address-{{ $address->id }}"
                                                    style="{{ count($errors->addressUpdate) > 0 && $errors->addressUpdate->first('address_id') == $address->id ? 'display:block' : '' }}; margin:20px;border:2px solid;border-color: #a0a0a0">

                                                    <form action="{{ route('home.user.addresses.update', $address->id) }}"
                                                        method="POST">
                                        ...
                                        <div class="collapse-address-create-content"
                                            ...
                                            <form action="{{ route('home.user.addresses.store') }}" method="POST">
                                                @csrf
