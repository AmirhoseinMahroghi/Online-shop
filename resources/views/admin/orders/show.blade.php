    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-4 p-5 bg-white">
            <div class="mb-4 text-center text-md-right">
                <h5 class="font-weight-bold">شماره فاکتور : {{ $order->order_number }}</h5>
            </div>
            <hr>
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <label>مبلغ</label>
                    <input class="form-control" type="text" value="{{ number_format($order->total_amount) . ' تومان ' }}" disabled>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" type="text" value="{{ number_format($order->coupon_amount) . ' تومان ' }}" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label>مبلغ پرداختی</label>
                    <input class="form-control" type="text" value="{{ number_format($order->paying_amount) . ' تومان ' }}" disabled>
                </div>
                <div class="form-group col-md-3">
