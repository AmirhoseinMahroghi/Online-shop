                                ...
                                <th>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('admin.products.image.edit', $product->id) }}" class="dropdown-item text-right"> ویرایش تصاویر </a>

                                            <a href="{{ route('admin.products.edit.category', $product->id) }}" class="dropdown-item text-right"> ویرایش دسته بندی و ویژگی
                                            </a>
